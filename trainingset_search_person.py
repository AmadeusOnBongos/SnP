...
parser.add_argument('--result_dir', type=str, metavar='PATH', default='results/sample_data_market/')
parser.add_argument('--c_num', default=57, type=int, help='number of cluster')
parser.add_argument('--n_num_id', default=2860, type=int, help='number of ids')
...
parser.add_argument('--output_data', type=str, metavar='PATH', default='/data/reid_data/market/SnP_2860IDs_0.5Imgs_061')
parser.add_argument('--ID_sampling_method', type=str, default='SnP', choices=['greedy', 'random', 'SnP'], help='how to sample')
parser.add_argument('--img_sampling_ratio', default=0.5, type=float, help='image sampling ratio')
...
data_dict = {
        ...
        'unreal': 'data/reid_data/unreal_v3.1/images/', #unreal
