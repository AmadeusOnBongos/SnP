...
parser.add_argument('--output_data', type=str, metavar='PATH', default='output_data/SnP_market_test/')
...
data_dict = {
        ...
        # 'unreal': 'data/reid_data/unreal/unreal_v3.1/images/', #unreal
